...
public class CoromandelWHDto {
    ...
    public CoromandelWHDto(String lepNo, String truckNo, String driverName, String commodity, String grossWeight, String previousRMGNo, String previousRMGNoDesc) {
        this.lepNo = lepNo;
